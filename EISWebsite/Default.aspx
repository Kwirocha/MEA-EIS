...
<head>
	...
	<!-- Open Sans fonts -->
	<link rel="stylesheet"  href="css/fontOpenSan.css" />
			...
			<div class="container">
				...
				<ul class="touch">
					<li>
						...
						<p>713-4888<br />713-4661</p>
					</li>
					<li>
						<img src="img/mail.png" alt="Mail" title="Mail">
						<p>ictcc@mea.or.th<br /></p>
					</li>
					<li>
						<img src="img/map.png" alt="Map" title="Map">
						<p>21 Rat Burana Rd., Rat Burana, <br />Rat Burana, Bangkok 10140</p>
					</li>
				</ul><!-- .touch -->
		...
		<div class="navbar megamenu-width">
			<div class="container">
				...
				<div class="navbar-inner">
						...
						<img src="img/logo.png" alt="EIS Website">
					</a><!-- .logo -->
		...
		<div id="page-slider" >
			<ul>
				<li data-transition="zoomout" data-masterspeed="1300">
					...
					<!-- LAYER NR. 1 -->
					<div class="tp-caption slider-title text-right sfl" data-x="right" data-hoffset="-15" data-y="top" data-voffset="130" data-speed="1000" data-start="500" data-easing="Back.easeInOut" data-endspeed="300" style="color:#083f68">EIS Website</div>

					<!-- LAYER NR. 2 -->
					<div class="tp-caption slider-sub-title text-right sfl" data-x="right" data-hoffset="-15" data-y="center" data-speed="1100" data-start="600" data-easing="Back.easeInOut" data-endspeed="300" style="color:#0A1635">Increase your productivity, business<br/> and status with this awesome theme</div>
				...
				<li data-transition="zoomout" data-masterspeed="1300">
					...
					<!-- LAYER NR. 1 -->
					<div class="tp-caption slider-title sfr" data-x="15" data-y="top" data-voffset="130" data-speed="800" data-start="700" data-easing="Back.easeInOut" data-endspeed="300" style="color:#162036">EIS Website</div>

					<!-- LAYER NR. 2 -->
					<div class="tp-caption slider-sub-title sfl" data-x="15" data-y="center" data-speed="1000" data-start="800" data-easing="Back.easeInOut" data-endspeed="300" style="color:#141452">Here you will find everything <br /> you need for you</div>
				...
				<div class="row row-inline">
					<div class="col-md-7">
						...
						<ul class="touch">
							...
							<li><i class="fa fa-phone"></i><p>713-4888<br />713-4662</p></li>
