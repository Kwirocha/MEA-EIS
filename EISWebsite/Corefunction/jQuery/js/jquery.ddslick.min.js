( function(a) {
    ...
    function g(a, b) {
     ...
     function k(b) {
       ...
       var b = {}
       , c = { data: [], keepJSONItemsOnTop: false, width: 78, height: null, background: "#eee", selectText: "", defaultSelectedIndex: null,
       ...
       , f = '<style id="css-ddslick" type="text/css">' + ".dd-select{ border-radius:2px; border:solid 1px #ccc;  height:20px; position:relative; cursor:pointer;}"
        + ".dd-desc { color:#aaa; display:block; overflow: hidden; font-weight:normal; line-height: 1.4em; }"
        + ".dd-selected{ overflow:hidden; display:block; padding:1px 2px 0px 8px; font-weight:bold;}"
        ...
        + ".dd-container{ position:relative;}​ .dd-selected-text { font-weight:bold}​</style>";
          ...
          b.init = function(b) {
           ...
           if (b.selectText.length > 0 && b.defaultSelectedIndex == null) { c.find(".dd-selected").html(b.selectText) }
            ...
            g(c, o) }
           c.find(".dd-select").on("click.ddslick",
    ...
    return this.each(function() 
     {
            ...
            if (c) { var d = c.original; b.removeData("ddslick").unbind(".ddslick").replaceWith(d) }
      })
